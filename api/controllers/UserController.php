...
class UserController
{
    ...
    public function index()
    {
        ...
        // SECURITY: Only show users that belong to THIS specific PAE
        // Exclude:
        // 1. Super Admin (role_id = 1)
        // 2. Users with NULL pae_id (global users)
        // 3. Users from other PAEs
    ...
    public function update($id)
    {
        ...
        // SECURITY: Ensure user belongs to THIS PAE and is not Super Admin or global user
        $checkQuery = "SELECT id FROM " . $this->table_name . " 
                       WHERE id = :id 
                         AND pae_id = :pae_id 
                         AND role_id != 1
                         AND pae_id IS NOT NULL";
        $checkStmt = $this->conn->prepare($checkQuery);
